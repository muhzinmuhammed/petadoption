                                ...
                                <div class="row">
									...
									<div class="col-md-4">
										<div class="review-form">
												...
												<label>Weigth</label>
												<input type="text" class="form-control" placeholder="Enter Weigth">
									...
									<div class="col-md-6">
										<div class="review-form">
											...
											<input type="text" class="form-control" placeholder="Enter Needs">
										</div>
									</div>
									<div class="col-md-6">
										<div class="review-form">
											<label>Last vaccation Date</label>
                                ...
                                <div class="row">
									...
									<div class="col-md-4">
										<div class="review-form">
											...
											<button class="btn btn-primary btn-upload"><i class="bx bx-cloud-upload"></i>Upload Documents</button>
										</div>
									</div>
									<div class="col-md-12">
		...
		<div class="add-property-wrap">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="review-form">
						<label class="d-none d-md-block">&nbsp;</label>
						<button class="btn btn-primary btn-upload"><i class="bx bx-cloud-upload"></i>Upload Image</button>
					</div>
				</div>
				<div class="col-md-12">
					<div class="upload-list">
						...
						<p><i class="bx bx-check-double"></i>Image uploaded successfully</p>
					</div>
				</div>
			</div>
		</div>
                                ...
                                <div class="row">
									<div class="col-md-12">
										<div class="gallery-property">
											<ul>
												<li>
													<img src="assets/img/gallery/gallery-01.jpg" alt="Image">
													<a href="javascript:void(0);"><i class="bx bx-trash"></i></a>
												</li>
												<li>
													<img src="assets/img/gallery/gallery-02.jpg" alt="Image">
													<a href="javascript:void(0);"><i class="bx bx-trash"></i></a>
												</li>
												<li>
													<img src="assets/img/gallery/gallery-03.jpg" alt="Image">
													<a href="javascript:void(0);"><i class="bx bx-trash"></i></a>
												</li>
											</ul>
										</div>
						...
						<div class="col-lg-8"> 
							<div class="add-property-wrap">
                                <div class="row">
									<div class="col-md-12">
										<div class="review-form">
											<label>Enter Description of Pet</label>
					...
					<div class="row">
						<div class="col-md-12">                           
						   <div class="property-submit">
							<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#success">Add Pet</a>
							  <!-- <a href="index.html" class="btn btn-primary">Add Pet</a> -->
						   </div>
					   </div>
					</div>
							...
							<div class="modal-content">
								<div class="modal-body">
									<div class="success-popup">
										...
										<h5>Added To Waiting list</h5>
										<p>Verfication process is ongoing</p>
